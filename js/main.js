(function ($) {
    ...
    var additionalFrenchTranslations = {
        ...
        "Mining Operators and Project Owners - Partners - LabCongo": "Opérateurs miniers et porteurs de projets - Partenaires - LabCongo",
        "Academic and Training Institutions - Partners - LabCongo": "Institutions académiques et de formation - Partenaires - LabCongo",
        "Public and Regulatory Stakeholders - Partners - LabCongo": "Acteurs publics et réglementaires - Partenaires - LabCongo",
        "Technology and Equipment Providers - Partners - LabCongo": "Fournisseurs de technologies et d’équipements - Partenaires - LabCongo",
        "Partner Details": "Détails des partenaires",
        "Projects - LabCongo": "Projets - LabCongo",
        "Activities - LabCongo": "Activités - LabCongo",
        "Partnership network": "Réseau de partenariats",
        "Collaboration that strengthens mining analysis in the DRC": "Une collaboration qui renforce l’analyse minière en RDC",
        "Technical partnerships, institutional support, and local capacity building aligned with LabCongo standards.": "Des partenariats techniques, un appui institutionnel et un renforcement des capacités locales alignés sur les standards de LabCongo.",
        ...
        "Technical depth in mining analysis and laboratory methods.": "Une solide expertise en analyse minière et en méthodes de laboratoire.",
        "Capacity building and skills development rooted in the DRC.": "Renforcement des capacités et développement des compétences ancrés en RDC.",
        "Capacity": "Capacité",
        ...
        "View Partner Categories": "Voir les catégories de partenaires",
        ...
        "LabCongo's partner ecosystem spans four key areas that support mining analysis, local capacity, and responsible sector development.": "L’écosystème des partenaires de LabCongo couvre quatre domaines clés qui soutiennent l’analyse minière, les capacités locales et le développement responsable du secteur.",
        "Mining Operators and Project Owners": "Opérateurs miniers et porteurs de projets",
        "Mining Operators": "Opérateurs miniers",
        ...
        "Exploration teams, mining operators, and project owners needing reliable analytical data.": "Équipes d’exploration, opérateurs miniers et porteurs de projets ayant besoin de données analytiques fiables.",
        "Academic and Training Institutions": "Institutions académiques et de formation",
        "Academic & Training": "Académique et formation",
        ...
        "Schools, universities, and training organizations supporting local technical skills.": "Écoles, universités et organismes de formation soutenant les compétences techniques locales.",
        "Public and Regulatory Stakeholders": "Acteurs publics et réglementaires",
        "Public & Regulatory": "Public et réglementaire",
        ...
        "Institutions connected to traceability, compliance, and responsible sector development.": "Institutions liées à la traçabilité, à la conformité et au développement responsable du secteur.",
        "Technology and Equipment Providers": "Fournisseurs de technologies et d’équipements",
        "Technology & Equipment": "Technologie et équipements",
        ...
        "Providers strengthening analytical workflows, equipment reliability, and calibration.": "Fournisseurs qui renforcent les flux analytiques, la fiabilité des équipements et l’étalonnage.",
        "See More": "Voir plus",
        ...
        "Explore Details": "Explorer les détails",
        "View All Partner Details": "Voir tous les détails des partenaires",
        "Partner category": "Catégorie de partenaire",
        "Category partners": "Partenaires de la catégorie",
        "View by category": "Voir par catégorie",
        "Partners in this category": "Partenaires dans cette catégorie",
        "Each category shows its partner organizations with a presentation text, a partner photo, a logo, and direct links to the official website and social networks.": "Chaque catégorie présente ses organisations partenaires avec un texte de présentation, une photo du partenaire, un logo et des liens directs vers le site officiel et les réseaux sociaux.",
        "Website": "Site web",
        "Want to become a partner?": "Vous souhaitez devenir partenaire ?",
        "Main contribution": "Contribution principale",
        "Exploration support": "Appui à l’exploration",
        "Production QA/QC": "QA/QC de production",
        "Technical reporting": "Reporting technique",
        "Student exposure": "Exposition des étudiants",
        "Technician training": "Formation des techniciens",
        "Research exchange": "Échange en recherche",
        "Traceability inputs": "Apports pour la traçabilité",
        "Compliance support": "Appui à la conformité",
        "Sector governance": "Gouvernance du secteur",
        "Equipment supply": "Fourniture d’équipements",
        "Calibration support": "Appui à l’étalonnage",
        "Workflow improvement": "Amélioration des flux de travail",
        "Reliable analytical results for operational decisions.": "Des résultats analytiques fiables pour les décisions opérationnelles.",
        "Practical skills anchored in the Congolese mining context.": "Des compétences pratiques ancrées dans le contexte minier congolais.",
        "Better documentation and stronger responsible mining practices.": "Une meilleure documentation et des pratiques minières responsables renforcées.",
        "More stable laboratory performance and technical continuity.": "Une performance de laboratoire plus stable et une meilleure continuité technique.",
        "LabCongo partner category, collaboration scope, and validated organization profile.": "Catégorie de partenaire LabCongo, périmètre de collaboration et profil d’organisation validé.",
        "Working model": "Mode de collaboration",
        "How collaboration usually works": "Comment la collaboration fonctionne généralement",
        "Needs Alignment": "Alignement des besoins",
        "Define the technical objective, the expected outputs, and the operational context for the collaboration.": "Définir l’objectif technique, les résultats attendus et le contexte opérationnel de la collaboration.",
        "Technical Execution": "Exécution technique",
        "Coordinate analyses, support activities, equipment inputs, or institutional exchanges under clear quality rules.": "Coordonner les analyses, les activités d’appui, les apports en équipements ou les échanges institutionnels selon des règles qualité claires.",
        "Reporting & Follow-up": "Reporting et suivi",
        "Deliver traceable results, recommendations, and next-step actions that sustain long-term collaboration.": "Fournir des résultats traçables, des recommandations et des actions de suivi qui soutiennent une collaboration durable.",
        "What Partnerships Mean at LabCongo": "Ce que signifient les partenariats chez LabCongo",
        "Every partnership is built around technical discipline, shared accountability, and measurable local value.": "Chaque partenariat repose sur une discipline technique, une responsabilité partagée et une valeur locale mesurable.",
        "Every partnership at LabCongo is grounded in a common goal: better data for better decisions in the DRC mining sector.": "Chaque partenariat chez LabCongo repose sur un objectif commun : de meilleures données pour de meilleures décisions dans le secteur minier de la RDC.",
        "We value collaborations that improve analysis quality, strengthen professional skills, and support a more transparent and responsible mining ecosystem.": "Nous valorisons les collaborations qui améliorent la qualité des analyses, renforcent les compétences professionnelles et soutiennent un écosystème minier plus transparent et responsable.",
        "Analytical Collaboration": "Collaboration analytique",
        ...
        "Kivu Mineral Resources works with LabCongo for exploration support, routine ore characterization, and production quality control across active mining sites.": "Kivu Mineral Resources travaille avec LabCongo pour l’appui à l’exploration, la caractérisation courante du minerai et le contrôle qualité de la production sur des sites miniers actifs.",
        "Katanga Exploration Group relies on LabCongo for sample preparation planning, geochemical screening, and technical reporting that supports resource evaluation.": "Katanga Exploration Group s’appuie sur LabCongo pour la planification de la préparation des échantillons, le criblage géochimique et le reporting technique soutenant l’évaluation des ressources.",
        "Copperbelt QA Alliance partners with LabCongo to verify assay consistency, monitor turnaround discipline, and document traceable laboratory controls.": "Copperbelt QA Alliance collabore avec LabCongo pour vérifier la cohérence des dosages, suivre la discipline des délais et documenter des contrôles de laboratoire traçables.",
        "Institut Minier de Kinshasa collaborates with LabCongo to expose students to laboratory methods, mineral analysis workflows, and applied mining science.": "L’Institut Minier de Kinshasa collabore avec LabCongo pour exposer les étudiants aux méthodes de laboratoire, aux flux d’analyse minérale et à la science minière appliquée.",
        "Congo Technical Training Hub develops technician upskilling programs with LabCongo around sampling discipline, safety, and analytical best practices.": "Congo Technical Training Hub développe avec LabCongo des programmes de montée en compétences des techniciens autour de la discipline d’échantillonnage, de la sécurité et des bonnes pratiques analytiques.",
        "Great Lakes Research Exchange supports joint projects, technical seminars, and practical laboratory immersion tied to local mining-sector needs.": "Great Lakes Research Exchange soutient des projets conjoints, des séminaires techniques et une immersion pratique en laboratoire liée aux besoins locaux du secteur minier.",
        "The DRC Mineral Governance Office engages LabCongo for traceable technical information, mineral verification support, and sector documentation.": "Le DRC Mineral Governance Office sollicite LabCongo pour des informations techniques traçables, l’appui à la vérification minérale et la documentation sectorielle.",
        "Responsible Mining Standards Forum works with LabCongo on compliance-linked technical evidence, reference documentation, and quality-driven reporting.": "Responsible Mining Standards Forum travaille avec LabCongo sur des éléments techniques liés à la conformité, la documentation de référence et un reporting guidé par la qualité.",
        "Chain of Custody Initiative partners with LabCongo to reinforce traceability workflows, analytical recordkeeping, and responsible supply-chain controls.": "Chain of Custody Initiative collabore avec LabCongo pour renforcer les flux de traçabilité, l’enregistrement analytique et les contrôles responsables de la chaîne d’approvisionnement.",
        "Precision Lab Systems supports LabCongo with laboratory equipment deployment, replacement planning, and operational continuity for core analytical tools.": "Precision Lab Systems soutient LabCongo dans le déploiement des équipements de laboratoire, la planification des remplacements et la continuité opérationnelle des outils analytiques clés.",
        "GeoAnalytics Instruments collaborates with LabCongo on analytical upgrades, method reliability, and technology adoption for mining laboratory workflows.": "GeoAnalytics Instruments collabore avec LabCongo sur l’amélioration des analyses, la fiabilité des méthodes et l’adoption technologique pour les flux de laboratoire minier.",
        "Calibration Support Africa helps LabCongo maintain equipment performance through preventive maintenance, calibration discipline, and technical interventions.": "Calibration Support Africa aide LabCongo à maintenir la performance des équipements grâce à la maintenance préventive, à la discipline d’étalonnage et à des interventions techniques.",
        ...
        "Local capacity": "Capacité locale",
        "Reliable data": "Données fiables",
        "Students learning in a modern school laboratory": "Élèves apprenant dans un laboratoire scolaire moderne",
        "Education Project": "Projet éducatif",
        "Modern School Laboratories for Early Scientific Training": "Des laboratoires scolaires modernes pour une formation scientifique dès le bas âge",
        "LabCongo is preparing a program to equip schools with modern, practical laboratories so students can discover science, observation, measurement, and experimentation from an early age.": "LabCongo prépare un programme visant à équiper les écoles de laboratoires modernes et pratiques afin que les élèves découvrent la science, l’observation, la mesure et l’expérimentation dès le bas âge.",
        "The project aims to strengthen local scientific culture by giving schools access to safe equipment, guided laboratory activities, teacher support, and learning environments that connect classroom theory with real technical practice.": "Le projet vise à renforcer la culture scientifique locale en donnant aux écoles accès à des équipements sécurisés, à des activités pratiques encadrées, à un appui aux enseignants et à des environnements d’apprentissage qui relient la théorie en classe à la pratique technique réelle.",
        "By investing in young learners, LabCongo wants to help build a future generation of technicians, engineers, researchers, and responsible professionals able to contribute to the DRC's scientific and industrial development.": "En investissant dans les jeunes apprenants, LabCongo souhaite contribuer à former une future génération de techniciens, d’ingénieurs, de chercheurs et de professionnels responsables capables de participer au développement scientifique et industriel de la RDC.",
        "School laboratories": "Laboratoires scolaires",
        "Early scientific training": "Formation scientifique précoce",
        "Local talent development": "Développement des talents locaux",
